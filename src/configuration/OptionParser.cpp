...
void OptionParser::initialize() {
    ...
    _common.add_options()
            ...
            "search-tree-file-path",
            boost::program_options::value<std::string>(&(*_stringOptions)[Options::SEARCH_TREE_FILE_PATH])->default_value(
                    (*_stringOptions)[Options::SEARCH_TREE_FILE_PATH]),
            "Search tree generated by last verification"
            ) (
                    "search-tree-summary-path",
                    boost::program_options::value<std::string>(&(*_stringOptions)[Options::SEARCH_TREE_SUMMARY_PATH])->default_value(
                            (*_stringOptions)[Options::SEARCH_TREE_SUMMARY_PATH]),
                            "search tree summary path for output"
            );
#ifdef ENABLE_GUROBI
        ( "milp",
