...
PiecewiseLinearConstraint *Engine::pickSplitPLConstraintBasedOnIntervalWidth() {
    ...
    if (largestIntervalSoFar == 0)
        ...
        return generateInputDisjunctiveConstraint(inputVariableWithLargestInterval);
    }
}
...
PiecewiseLinearConstraint *Engine::pickSplitPLConstraint(DivideStrategy
    ...
    PiecewiseLinearConstraint *candidatePLConstraint = nullptr;
...
PiecewiseLinearConstraint *Engine::generateInputDisjunctiveConstraint(int inputVariable) {
    double mid = (_tableau->getLowerBound(inputVariable)
                  + _tableau->getUpperBound(inputVariable)
                 ) / 2;
    PiecewiseLinearCaseSplit s1;
    s1.storeBoundTightening(Tightening(inputVariable,
                                       mid, Tightening::UB));
    PiecewiseLinearCaseSplit s2;
    s2.storeBoundTightening(Tightening(inputVariable,
                                       mid, Tightening::LB));
